...
var enemy = new Fighter((_ref = {
  ...
  framesMax: 4,
  scale: 2.5
}, _defineProperty(_ref, "offset", {
  x: 120,
  y: 50
}), _defineProperty(_ref, "sprites", {
  idle: {
    imageSrc: '/fighter/gameAssets/oak_woods_v1.0/Martial hero 3/Sprite/Idle.png',
    framesMax: 10
  },
  run: {
    imageSrc: '/fighter/gameAssets/oak_woods_v1.0/Martial hero 3/Sprite/Run.png',
    framesMax: 8
  },
  jump: {
    imageSrc: '/fighter/gameAssets/oak_woods_v1.0/Martial hero 3/Sprite/Going Up.png',
    framesMax: 3
  },
  fall: {
    imageSrc: '/fighter/gameAssets/oak_woods_v1.0/Martial hero 3/Sprite/Going Down.png',
    framesMax: 3
  },
  attack1: {
    imageSrc: '/fighter/gameAssets/oak_woods_v1.0/Martial hero 3/Sprite/Attack3.png',
    framesMax: 9
  },
  takeHit: {
    imageSrc: '/fighter/gameAssets/oak_woods_v1.0/Martial hero 3/Sprite/Take Hit.png',
    framesMax: 3
  },
  death: {
    imageSrc: '/fighter/gameAssets/oak_woods_v1.0/Martial hero 3/Sprite/Death.png',
    framesMax: 11
  }
}), _defineProperty(_ref, "attackBox", {
  offset: {
    x: -115,
    y: 80
  },
